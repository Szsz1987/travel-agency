...
for(let type in optionTypes){
  describe(`Component OrderOption with type=${type}`, () => {
    ...
    }); // metoda .dive renderuje subkomponenty

    // Funkcja beforeEach wykona się przed uruchomieniem każdego z testów it – oznacza to, że
    // każdy test będzie miał do dyspozycji świeżo wyrenderowany komponent OrderOption, i
    // nie musimy używać funkcji shallow w każdym z testów!

    /* common tests */
    // będziemy tutaj pisać testy dotyczące każdego subkomponentu,
    ...
    /* type-specific tests */
    // tutaj znajdziesz wyrażenie switch – w nim będziemy pisać testy dla konkretnych typów opcji.
    switch (type) {
      case 'dropdown': {
        /* tests for dropdown */
        ...
        it('should run setOrderOption function on change', () => {
          ...
          // metoda .simulate przyjmuje jeden lub dwa argumenty.
          // Pierwszym z nich jest rodzaj eventu, jaki ma zostać zasymulowany 
          // – w tym wypadku event change. Drugi argument to wartość przekazywana
          // handlerowi tego eventu. 
          expect(mockSetOrderOption).toBeCalledTimes(1);
          // tutaj spr., czy ta funkcja została wykonana dokładnie jeden raz 
          expect(mockSetOrderOption).toBeCalledWith({ [mockProps.id]: testValue });
          // tutaj spr., czy została wywołana z poprawnymi argumentami  
        });
        break;
      } 
